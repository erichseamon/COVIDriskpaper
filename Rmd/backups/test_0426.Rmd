...
USlist1 %>%  kable(escape = FALSE, booktabs = TRUE)  %>% kable_classic_2(full_width = F) %>% footnote(general = "Bold = significant value") %>% add_header_above(c(" " = 1,"Alpha Wave" = 2, "Delta Wave" = 2, "Omicron Wave" = 2))

USlist_R %>% kable(escape = FALSE, booktabs = TRUE)  %>% kable_classic_2(full_width = F)
