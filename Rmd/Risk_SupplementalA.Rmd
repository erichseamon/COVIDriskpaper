...
<!-- ## Figure S36: Population Adjusted Deaths vs Ideology over time -->
...
<!-- ## Figure S37: Region 9 Alpha Wave Standardized Coefficients Plot -->
...
<!-- ## Figure S38: Region 9 Delta Wave Standardized Coefficients Plot -->
...
<!-- ## Figure S39: Region 9 Omega Wave Standardized Coefficients Plot -->
...
<!-- ## Figure S43: Region 10 Alpha Wave Standardized Coefficients Plot -->
...
<!-- ## Figure S44: Region 10 Delta Wave Standardized Coefficients Plot -->
...
<!-- ## Figure S45: Region 10 Omicron Wave Standardized Coefficients Plot -->
...
<!-- # plot_model(eval(parse(text=regionlist4_list_ideology_deathS47[10])), type = "std2", show.values = "TRUE", pred.labels =  c("Socioeconomic", "Household Composition & Disability", "Minority Status & Language", "Housing Type & Transportation", "Political Divergence", "Democratic Voting Pct","Vaccination Rate","Population Density",  "Obesity", "Uninsured Adults",   "Unemployed",  "Diabetes", "Food Insecurity",  "Social Associations", "Age over 65", "Broadband Access")) -->
<!-- ``` -->
...
webshot::webshot(url = "./html/modeloutput_C.html", file = "./png/modeloutput_C.png")

```

## Figure S17: Model Results: Regression R2 Plot
...
R3$Region <- rep(c("Region 1&2", "Region 3", "Region 4", "Region 5", "Region 6", "Region 7", "Region8", "Region 9", "Region 10"), 3)
R3$Region <- as.factor(R3$Region)

names(R3)[names(R3) == 'alphaR'] <- 'R2'


R3$Region <- factor(R3$Region, levels=c("Region 1&2", "Region 3", "Region 4", "Region 5", "Region 6", "Region 7", "Region8", "Region 9", "Region 10"))
...
## Table T15: Regionalized Regression Model Results: Significance Table
...
levels(ado_P$variable) <- c("Socioeconomic Status", "Household Composition and Disability", "Housing Type and Transportation", "Unemployment", "Food Insecurity", "Lack of Broadband Access", "Diabetes", "Obesity", "Population Density", "Social Associations", "Age over 65+", "Democratic Voting Pct", "Vaccination Rate", "Minority Status and Language")
...
p2 <- qplot(test_new2$deaths_adjusted, 1-test_new2$pct, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family="serif")) + labs(y = "Voting", x = "Population Adjusted Deaths") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
# pctrc1 <- colorRampPalette(colors = rev(c("darkorchid4", "darkorchid3", "darkorchid2", "darkorchid1")))(length(counties_merged2$deaths_adjusted[counties_merged2$deaths_adjusted >= mean(counties_merged2$deaths_adjusted)]))
# 
# pctrc2 <- colorRampPalette(colors = rev(c("darkorange4", "darkorange3", "darkorange2", "darkorange1")))(length(counties_merged2$deaths_adjusted[counties_merged2$deaths_adjusted < mean(counties_merged2$deaths_adjusted)]))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$RPL_THEME1, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Socioeconomic Status") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$RPL_THEME2, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Minority Status") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$RPL_THEME3, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Household Composition") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$RPL_THEME4, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Housing Type") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$pct, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Voting") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Series_Complete_Pop_Pct, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Vaccination Rate") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$density_scaled, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Population Density") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Obesity, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Obesity") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Unemployed, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Unemployed") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Uninsured_Adults, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Uninsured Adults") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Associations, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Social Associations") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Diabetes, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Diabetes") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$Food_Insecurity, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Food Insecurity") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$broadband_access.y, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Broadband Access") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
test_new2 <- subset(test_new, pct !=0)
p2 <- qplot(test_new2$age65_ratio, test_new2$deaths_adjusted, geom='smooth', span =0.5, se=FALSE) + theme_minimal() + theme(text = element_text(size = 28, family = "serif")) + labs(y = "Deaths", x = "Age Over 65") + theme(plot.margin = unit(c(0,.2,0,.8), "cm"), axis.title.y = element_text(vjust=3))
...
geom_point(data=deaths_mp[deaths_mp$is_inf,], aes(x=x, y=wx, size = 1), shape=1, color = "gray", show.legend = FALSE) + ggtitle("Delta Wave: Population Adjusted Deaths x Voting") +
  xlab("") + ylab("Spatially Lagged Values") + theme(text = element_text(size = 28, family="serif"))  + theme(legend.position="top", legend.key.width = unit(2.5, 'cm')) + sc + geom_text(color="black", family="serif", x=.00625, y=.0005, size=8, check_overlap = TRUE, label=paste("Moran's I = ", round(mt$estimate[1], 3), sep=''))
...
## Table T16: GWRF Alpha Wave OOB vs. Global R2
...
## Table T17: GWRF Delta Wave: OOB vs Global R2
...
## Table T18: GWRF Omicron Wave: OOB vs Global R2
